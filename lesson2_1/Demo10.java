...
public class Demo10 {
	public static void main(String[] args) {
		SingleQuestion10 question1 = new SingleQuestion10(1, "最好的視頻就業課程？",
				new String[] { "A.我贏教育", "B.其他" }, "A");
		SingleQuestion10 question3 = new SingleQuestion10(2, "愛情電影是？",
		...
		System.out.println("===================================");
		//現在要出三個題目，既有單選題，又有多選題
		Question10[] qs = new Question10[] {question1,question3,question2};
		//父類可以引用子類的實例
		//Question類的引用，既可以飲用SingleQuestion的實例，也可以引用MultiQuestion的實例
		for(Question10 q : qs) {
			q.printQuestion();
			System.out.println(q.check(new String[] {"A"}));
			//如果引用的是SingleQuestion調用的就是SingleQuestion的check方法
			//如果引用的是MultiQuestion調用的就是MultiQuestion的check方法
		}
	}
}
